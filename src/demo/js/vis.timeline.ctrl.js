(function() {
    ...
    angular
        .module('mobileApp')
        .controller('visTimelineCtrl', visTimelineCtrl)

    visTimelineCtrl.$inject = ['$location', "$document"];

    function visTimelineCtrl($location, $document) {
        ...
        function visualization() {
            ...
            var groups = new vis.DataSet([
                { "content": "大众", "id": "大众", "value": 1, className: 'openwheel' },
                { "content": "本田", "id": "本田", "value": 2, className: 'rally' },
                { "content": "丰田", "id": "丰田", "value": 3, className: 'motorcycle' },
            ...
            var items = new vis.DataSet([
                { start: new Date(2015, 0, 10), end: new Date(2015, 0, 11), group: "大众", className: "openwheel", content: "Argentina", id: "531@motocal.net" },
                { start: new Date(2015, 0, 22), end: new Date(2015, 0, 26), group: "本田", className: "rally", content: "Rallye Monte-Carlo", id: "591@motocal.net" },
                { start: new Date(2015, 1, 4), end: new Date(2015, 1, 8), group: "丰田", className: "motorcycle", content: "Sepang MotoGP Test 1", id: "578@motocal.net" },
                { start: new Date(2015, 1, 12), end: new Date(2015, 1, 16), group: "本田", className: "rally", content: "Rally Sweden", id: "592@motocal.net" },
                { start: new Date(2015, 1, 20), end: new Date(2015, 1, 23), group: "SBK", className: "motorcycle", content: "Australia", id: "616@motocal.net" },
                { start: new Date(2015, 1, 23), end: new Date(2015, 1, 27), group: "丰田", className: "motorcycle", content: "Sepang MotoGP Test 2", id: "579@motocal.net" },
                ...
                { start: new Date(2015, 2, 5), end: new Date(2015, 2, 9), group: "本田", className: "rally", content: "Rally Guanajuato Mexico", id: "593@motocal.net" },
                ...
                { start: new Date(2015, 2, 14), end: new Date(2015, 2, 15), group: "大众", className: "openwheel", content: "Miami, USA", id: "534@motocal.net" },
                { start: new Date(2015, 2, 14), end: new Date(2015, 2, 17), group: "丰田", className: "motorcycle", content: "Qatar MotoGP Test", id: "577@motocal.net" },
                ...
                { start: new Date(2015, 3, 4), end: new Date(2015, 3, 5), group: "大众", className: "openwheel", content: "Long Beach, USA", id: "535@motocal.net" },
                ...
                { start: new Date(2015, 3, 10), end: new Date(2015, 3, 13), group: "丰田", className: "motorcycle", content: "Americas", id: "540@motocal.net" },
                ...
                { start: new Date(2015, 3, 17), end: new Date(2015, 3, 20), group: "丰田", className: "motorcycle", content: "Argentina", id: "559@motocal.net" },
                ...
                { start: new Date(2015, 3, 23), end: new Date(2015, 3, 27), group: "本田", className: "rally", content: "Rally Argentina", id: "595@motocal.net" },
                ...
                { start: new Date(2015, 4, 1), end: new Date(2015, 4, 4), group: "丰田", className: "motorcycle", content: "Spain", id: "542@motocal.net" },
                ...
                { start: new Date(2015, 4, 9), end: new Date(2015, 4, 10), group: "大众", className: "openwheel", content: "Monaco", id: "536@motocal.net" },
                ...
                { start: new Date(2015, 4, 15), end: new Date(2015, 4, 18), group: "丰田", className: "motorcycle", content: "France", id: "543@motocal.net" },
                ...
                { start: new Date(2015, 4, 21), end: new Date(2015, 4, 25), group: "本田", className: "rally", content: "Rally de Portugal", id: "594@motocal.net" },
                ...
                { start: new Date(2015, 4, 23), end: new Date(2015, 4, 24), group: "大众", className: "openwheel", content: "Germany", id: "537@motocal.net" },
                ...
                { start: new Date(2015, 4, 29), end: new Date(2015, 5, 1), group: "丰田", className: "motorcycle", content: "Italy", id: "562@motocal.net" },
                ...
                { start: new Date(2015, 5, 6), end: new Date(2015, 5, 7), group: "大众", className: "openwheel", content: "Russia", id: "716@motocal.net" },
                { start: new Date(2015, 5, 6), end: new Date(2015, 5, 8), group: "BTCC", className: "touringcar", content: "Rounds 10, 11 & 12", id: "584@motocal.net" },
                { start: new Date(2015, 5, 11), end: new Date(2015, 5, 15), group: "本田", className: "rally", content: "Rally d'Italia Sardegna", id: "596@motocal.net" },
                { start: new Date(2015, 5, 12), end: new Date(2015, 5, 15), group: "丰田", className: "motorcycle", content: "Catalunya", id: "545@motocal.net" },
                ...
                { start: new Date(2015, 5, 25), end: new Date(2015, 5, 28), group: "丰田", className: "motorcycle", content: "Netherlands", id: "546@motocal.net" },
                ...
                { start: new Date(2015, 5, 27), end: new Date(2015, 5, 29), group: "大众", className: "openwheel", content: "United Kingdom", id: "538@motocal.net" },
                { start: new Date(2015, 6, 2), end: new Date(2015, 6, 6), group: "本田", className: "rally", content: "Rally Poland", id: "597@motocal.net" },
                ...
                { start: new Date(2015, 6, 10), end: new Date(2015, 6, 13), group: "丰田", className: "motorcycle", content: "Germany", id: "565@motocal.net" },
                ...
                { start: new Date(2015, 6, 30), end: new Date(2015, 7, 3), group: "本田", className: "rally", content: "Rally Finland", id: "598@motocal.net" },
                ...
                { start: new Date(2015, 7, 7), end: new Date(2015, 7, 10), group: "丰田", className: "motorcycle", content: "Indianapolis", id: "548@motocal.net" },
                ...
                { start: new Date(2015, 7, 10), end: new Date(2015, 7, 12), group: "大众", className: "openwheel", content: "Pre-season test 1", id: "769@motocal.net" },
                { start: new Date(2015, 7, 14), end: new Date(2015, 7, 17), group: "丰田", className: "motorcycle", content: "Czech Republic", id: "549@motocal.net" },
                { start: new Date(2015, 7, 17), end: new Date(2015, 7, 19), group: "大众", className: "openwheel", content: "Pre-season test 2", id: "770@motocal.net" },
                { start: new Date(2015, 7, 20), end: new Date(2015, 7, 24), group: "本田", className: "rally", content: "Rallye Deutschland", id: "599@motocal.net" },
                ...
                { start: new Date(2015, 7, 24), end: new Date(2015, 7, 26), group: "大众", className: "openwheel", content: "Pre-season test 3", id: "771@motocal.net" },
                ...
                { start: new Date(2015, 7, 28), end: new Date(2015, 7, 31), group: "丰田", className: "motorcycle", content: "Great Britain", id: "568@motocal.net" },
                ...
                { start: new Date(2015, 8, 10), end: new Date(2015, 8, 14), group: "本田", className: "rally", content: "Rally Australia", id: "600@motocal.net" },
                ...
                { start: new Date(2015, 8, 11), end: new Date(2015, 8, 14), group: "丰田", className: "motorcycle", content: "San Marino", id: "551@motocal.net" },
                ...
                { start: new Date(2015, 8, 25), end: new Date(2015, 8, 28), group: "丰田", className: "motorcycle", content: "Aragon", id: "570@motocal.net" },
                ...
                { start: new Date(2015, 9, 1), end: new Date(2015, 9, 5), group: "本田", className: "rally", content: "Rallye de France", id: "601@motocal.net" },
                ...
                { start: new Date(2015, 9, 9), end: new Date(2015, 9, 12), group: "丰田", className: "motorcycle", content: "Japan", id: "553@motocal.net" },
                ...
                { start: new Date(2015, 9, 16), end: new Date(2015, 9, 19), group: "丰田", className: "motorcycle", content: "Australia", id: "572@motocal.net" },
                ...
                { start: new Date(2015, 9, 22), end: new Date(2015, 9, 26), group: "本田", className: "rally", content: "Rally de Espana", id: "602@motocal.net" },
                ...
                { start: new Date(2015, 9, 23), end: new Date(2015, 9, 26), group: "丰田", className: "motorcycle", content: "Malaysia", id: "573@motocal.net" },
                ...
                { start: new Date(2015, 10, 6), end: new Date(2015, 10, 9), group: "丰田", className: "motorcycle", content: "Valencia", id: "556@motocal.net" },
                ...
                { start: new Date(2015, 10, 12), end: new Date(2015, 10, 16), group: "本田", className: "rally", content: "Wales Rally GB", id: "603@motocal.net" },
